...
class MemberRepositoryTest {
    ...
    public void searchPageSimpleTest() {
        ...
        MemberSearchCondition condition = new MemberSearchCondition();
        PageRequest pageRequest = PageRequest.of(0, 3); // 페이지 객체 생성
    ...
    public void searchPageComplexTest() {
        ...
        Page<MemberTeamDto> result2 = memberRepository.searchPageComplex2(condition, pageRequest);
    ...
    // spring data JPA 방식에 조건절만 붙혀쓰는 방식
    // left join 불가
    // service 단 등이 dto등 자바 객채가 아닌 querydsl 객체에 의존하게 됨
    // 이후에 코드가 복잡해지면 못쓰게 될 가능성이 있음
    @Test
